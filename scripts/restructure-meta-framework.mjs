...
const rootPages = {
  ...
  "papers.html": {
    ...
    <section class="grid-two">
      ...
      <article class="doc-card"><div class="doc-card-header"><h2>Core Framework Notes</h2><span class="chip">Framework</span></div><p>The current conceptual center, including capacity-forming functions, participatory capacity, internal regulation, external control, and collapse under pressure.</p><a class="text-link" href="pages/revised-framework-center.html">Open revised framework center</a></article>
